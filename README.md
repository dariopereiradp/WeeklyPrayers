<p align="center">
	<img width="100px" src="app/src/main/ic_launcher-playstore.png" align="center" alt="WKP" />
	<h2 align="center">Weekly Prayers</h2>
...
<p align="center">
	...
	<a href="#">
		<img src="https://img.shields.io/github/repo-size/dariopereiradp/WeeklyPrayers" />
	</a>
	<br />
	<br />
	<a href="#">
...
## Databases
This app uses Room to store data on database. It contains 2 databases file, and 2 databases. Each one has a class, an interface (dao) and a DB extends RoomDatabase
- ### PrayerCardsDB
- ### NotesDB
...
<html>
   ...
   <h3>Version 1.0 - 2021.03.07</h3>
   <p>Source code: </p>
   <a href="https://github.com/dariopereiradp/WeeklyPrayers">Github</a>
<h3>Functionalities</h3>
<li><strong>Prayer Days</strong></li>
<p>
...
<p>
    - You can use the journal to save whatever you want, for example, thoughts, prayers, answers of
    prayers, Bible verses and others.
</p>
<p>
...
<p>
    ...
    "dp.wkp.backup" will be created in a folder called "Weekly Prayers" at your Google Drive account
...
<p>
    - This app was created to help organizing your prayer time. Use it wisely, but don't depend on
    it to talk to God!
</p>
<p>
    - May God bless you using this app. If you find an error or have any suggestions, don't hesitate
    to contact us!
</p>
<br>
<p>
...
<p>
    ...
    encrypted (except the notes you encrypted, that are stored in plain encrypted text) so, the
    security of your information depends on you and the protection mechanisms of Google and Android.
</p>
   <p>
      © DPSoft 2021
   </p>
